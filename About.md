...
<style>
 ...
 #about-page .wrap {
  ...
  #about-page .experience-list li:first-child {
    border-top: 1px solid var(--line);
  }

  #about-page .experience-list li::before {
    content: "";
    width: 6px;
    height: 6px;
    border-radius: 50%;
  ...
  #about-page .btn:hover .arrow { transform: translateX(3px); }
  #about-page .btn:focus-visible { outline: 2px solid var(--sage-deep); outline-offset: 3px; }

  #about-page .btn-primary { background: var(--sage-deep); color: var(--paper); }
  #about-page .btn-primary:hover { background: var(--ink); box-shadow: 0 6px 18px rgba(43,51,46,0.18); }
