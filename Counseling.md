...
<style>
 ...
 #counseling-page .wrap {
  ...
  #counseling-page .content { position: relative; z-index: 1; }

  #counseling-page .eyebrow {
    font-size: 12.5px;
  ...
  #counseling-page .badge strong { font-weight: 600; color: var(--ink); }
  #counseling-page .badge span.loc { color: var(--ink-soft); }

  #counseling-page .divider {
    border: none;
    border-top: 1px solid var(--line);
    margin: 8px 0 40px;
  }

  #counseling-page .actions {
    display: flex;
  ...
  #counseling-page .btn:hover .arrow { transform: translateX(3px); }
  #counseling-page .btn:focus-visible { outline: 2px solid var(--sage-deep); outline-offset: 3px; }

  #counseling-page .btn-primary { background: var(--sage-deep); color: var(--paper); }
  #counseling-page .btn-primary:hover { background: var(--ink); box-shadow: 0 6px 18px rgba(43,51,46,0.18); }

  #counseling-page .btn-secondary { background: var(--paper); color: var(--ink); border: 1px solid var(--line); }
  #counseling-page .btn-secondary:hover { border-color: var(--clay-deep); box-shadow: 0 4px 14px rgba(43,51,46,0.08); }

  #counseling-page .btn small {
    display: block;
    font-family: 'Work Sans', sans-serif;
    font-weight: 400;
    font-size: 12.5px;
  ...
  #counseling-page .direct-row:first-of-type { border-top: 1px solid var(--line); }

  #counseling-page .direct-label {
    font-size: 12.5px;
  ...
  #counseling-page .direct-value { font-size: 16px; }
  #counseling-page .direct-value a { color: var(--ink); text-decoration: none; border-bottom: 1px solid var(--clay); }
  #counseling-page .direct-value a:hover { color: var(--clay-deep); }
</style>
